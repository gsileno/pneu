...
//    }
    ...
    void testLabelSimilarity() {

        Net sourceNet = PNML2PN.parseFile("./stories/BurglaryStory.pnml")
        Net targetNet = PNML2PN.parseFile("./stories/BurglaryTheftStory.pnml")

        Comparison.labelComparison2(sourceNet, targetNet)
